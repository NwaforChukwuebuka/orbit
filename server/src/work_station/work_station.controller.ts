...
export class WorkStationController {
  ...
  @ApiOperation({ 
    ...
    description: 'Creates a new work station with the specified configuration and settings'
  })
  @ApiBody({ type: CreateWorkStationDto, description: 'Work station data to create' })
  @ApiResponse({ 
    status: 201, 
  ...
  @ApiResponse({ status: 400, description: 'Invalid work station data provided' })
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieves a list of all work stations with their configurations'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiParam({ name: 'id', description: 'Work station unique identifier' })
  @ApiBody({ type: UpdateWorkStationDto, description: 'Updated work station data' })
  @ApiResponse({ 
    status: 200, 
